function resizeableWindows(windows) {
 ...
 function makeResizable(element, minW = 100, minH = 100, size = 20) {
  ...
  corner1.style.cursor = "nwse-resize";
  ...
  corner2.style.cursor = "nesw-resize";
  ...
  corner3.style.cursor = "nesw-resize";
  ...
  corner4.style.cursor = "nwse-resize";
